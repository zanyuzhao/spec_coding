...
- **流程/评估/对比**：如流程评估、与 OpenSpec 对比、最佳实践。
- **模板与指引**：如 spec 模板、**开发清单与归档检查列表**（[CHECKLISTS.md](./CHECKLISTS.md)）、**测试最佳实践**：[测试最佳实践](./testing_best_practices.md) - 测试策略、工具及可选性设计指南、新成员指引。
